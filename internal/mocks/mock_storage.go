...
// Source: github.com/EvgeniyBudaev/yandex-go-musthave-diploma-tpl/internal/storage (interfaces: Storage)
...
import (
	...
	storage "github.com/EvgeniyBudaev/yandex-go-musthave-diploma-tpl/internal/storage"
...
func (m *MockStorage) AddOrderForUser(ctx context.Context, arg0, arg1 string) (int, bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockStorage) Register(ctx context.Context, arg0 storage.Auth, passwordHash string) (string, error) {
	m.ctrl.T.Helper()
