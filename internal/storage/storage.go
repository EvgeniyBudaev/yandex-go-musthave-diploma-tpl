...
type Storage interface {
	...
	AddOrderForUser(ctx context.Context, externalOrderID string, userID string) (int, bool, error)
...
func (s *DBStorage) AddOrderForUser(ctx context.Context, id string, u string) (int, bool, error) {
	...
	return http.StatusAccepted, false, nil
}
